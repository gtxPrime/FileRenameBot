    ...
    if update_channel:
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                ...
                [
                    InlineKeyboardButton('Support Channel', url='https://t.me/BlackHarbour'),
                    InlineKeyboardButton('Feedback', url='https://t.me/BlackHarbour')
                ],
                [
                    InlineKeyboardButton('Other Bots', url='https://t.me/BlackHarbour'),
                    InlineKeyboardButton('Source', url='https://github.com/gtxPrime/FileRenameBot/')
                ]
            ]
        ),
